...
export default function TransactionsScreen() {
  ...
  const save = () => {
    ...
    if (!title.trim() || !numericAmount) {
      Alert.alert(t(locale, "newTransaction"), t(locale, "amountPlaceholder"));
      return;
    }
  ...
  return (
    <ScreenContainer containerClassName="bg-[#F8F7FC]" safeAreaClassName="bg-[#F8F7FC]">
      <ContextualHint
        screen="transactions"
        locale={locale}
        titleKey="transactionsHintTitle"
        bodyKey="transactionsHintBody"
        icon="receipt-long"
      />
      <FlatList
        data={transactions}
        ...
        ListHeaderComponent={
          <View style={{ paddingTop: 14, paddingBottom: 18, gap: 18 }}>
            {/* Header */}
            <View
              style={{
            ...
            >
              <View style={{ gap: 6, alignItems: isRTL ? "flex-end" : "flex-start" }}>
                ...
                <Text style={{ color: "#28243E", fontSize: 22, fontWeight: "900" }}>
              ...
              >
                <AppIcon name="trending-down" color="#FF8A65" size={22} />
              </View>
            </View>
          </View>
        }
      ...
      <Modal visible={showForm} transparent animationType="slide" onRequestClose={() => setShowForm(false)}>
        <KeyboardAvoidingView
          ...
          style={{ flex: 1, justifyContent: "flex-end", backgroundColor: "rgba(26,20,46,0.3)" }}
        >
          <View
            style={{
              backgroundColor: "#FFFFFF",
            ...
            <View style={{ flexDirection: isRTL ? "row-reverse" : "row", gap: 10 }}>
              <Pressable
                ...
                style={[
                  ...
                  type === "expense"
                    ? { backgroundColor: "#FFF1ED", borderColor: "#FF8A65" }
                    : { borderColor: "#EEEAF5" },
                ]}
              >
                <Text
                  style={{
                    color: type === "expense" ? "#E76546" : "#9996A8",
                    fontWeight: "800",
                    fontSize: 12,
                  }}
                >
              ...
              <Pressable
                ...
                style={[
                  ...
                  type === "income"
                    ? { backgroundColor: "#E5FAF2", borderColor: "#2EBD85" }
                    : { borderColor: "#EEEAF5" },
                ]}
              >
                <Text
                  style={{
                    color: type === "income" ? "#218A63" : "#9996A8",
                    fontWeight: "800",
                    fontSize: 12,
                  }}
                >
                ...
                {categoryKeys.map((key) => (
                  <Pressable
                    ...
                    style={[
                      ...
                      category === key
                        ? {
                            backgroundColor: `${categoryColors[key]}18`,
                            borderColor: categoryColors[key],
                          }
                        : { backgroundColor: "#FFFFFF", borderColor: "#EEEAF5" },
                    ]}
                  >
                    <Text
                      style={{
                        color: category === key ? categoryColors[key] : "#9996A8",
                        fontSize: 11,
                        fontWeight: "800",
                      }}
                    >
                      {t(locale, key as never)}
                    </Text>
                  </Pressable>
                ))}
              </View>
